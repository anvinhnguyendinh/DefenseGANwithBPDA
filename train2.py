...
def main(cfg,*args):
    ...
    if FLAGS.is_train:
        gan.train(output=FLAGS.output_path)
...
if __name__ == '__main__':
    ...
    flags.DEFINE_string("output_path", None, "Path to save generator")
    ...
    flags.DEFINE_string("defense_type", "none", "Type of defense [none|adv_tr]")
    flags.DEFINE_integer("batch_size", 50, "Batch size")
    flags.DEFINE_integer("rec_rr", 10, "Number of random restarts for the reconstruction")
    flags.DEFINE_integer("rec_iters", 50, "Number of reconstruction iterations")
