        ...
        if FLAGS.attack_type == 'fgsm':
            ...
            for j in range(len(listimg)):
                ...
                tflib.save_images.save_images(
                    ...
                    os.path.join('images_last', 'samples_{}_{}.png'.format(FLAGS.model, j))
                )
...
def main(cfg, argv=None):
    ...
    gan.load_generator()
    gan.generate_image(1,'random_defgan')
...
if __name__ == '__main__':
    ...
    flags.DEFINE_string("model_folder", "./trained/", "Folder with trained classifiers")
